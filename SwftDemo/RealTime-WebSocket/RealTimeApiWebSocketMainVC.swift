...
class RealTimeApiWebSocketMainVC: UIViewController {
    ...
    @IBAction func clickBackButton(_ sender: Any) {
        if WebSocketManager.shared.connected_status == "not_connected"{
            ...
            let alertVC = UIAlertController(title: "The websocket is connecting, So do you want to disconnect it? ", message: "", preferredStyle: .alert)
            let cancelAction = UIAlertAction(title: "Cancel", style: .cancel)
            let confirAction = UIAlertAction(title: "Confirm", style: .default) { alert in
                //stop play audio
                WebSocketManager.shared.audio_String = ""
